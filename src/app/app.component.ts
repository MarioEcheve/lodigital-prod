...
import { AutoLogoutService } from './sistema/services/auto-logout.service';
...
export class AppComponent {
  constructor(private router: Router, private appService: AppService, private layoutService: LayoutService,private autoLogOutService: AutoLogoutService) {
