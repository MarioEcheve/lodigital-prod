...
export class AppService {
  ...
  // Layout navbar color
  get layoutNavbarBg() {
    // FVS return this.themeSettingsService.getOption('navbarBg') || 'navbar-theme';
    return 'lighter';
  }

  // Layout sidenav color
  get layoutSidenavBg() {
    // FVS return this.themeSettingsService.getOption('sidenavBg') || 'sidenav-theme';
    return 'lighter';
  }

  // Layout footer color
  get layoutFooterBg() {
    // fvs return this.themeSettingsService.getOption('footerBg') || 'footer-theme';
    return 'lighter';
  }
